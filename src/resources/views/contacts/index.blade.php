    ...
    <div class="form-card">
        <form action="/confirm" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-field">
                    <div class="form-tel-fields">
                        <input type="text" name="tel1" class="form-input form-input--short" placeholder="080" value="{{ old('tel1', request('tel1', $tel1 ?? '')) }}" maxlength="5">
                        <span class="form-tel-sep">-</span>
                        <input type="text" name="tel2" class="form-input form-input--short" placeholder="1234" value="{{ old('tel2', request('tel2', $tel2 ?? '')) }}" maxlength="5">
                        <span class="form-tel-sep">-</span>
                        <input type="text" name="tel3" class="form-input form-input--short" placeholder="5678" value="{{ old('tel3', request('tel3', $tel3 ?? '')) }}" maxlength="5">
                    </div>
